...
export const Header = () => {
  ...
  return (
    <div className="bg-white border-t border-t-gray-600 text-gray-800 dark:bg-gray-900 dark:text-white z-0">
      <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        ...
        <div className='text-center pt-20 pb-8'>
          ...
          <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-sm text-gray-500 dark:text-gray-300'>
            This is your own space to think out loud, to share your thoughts without limitations. Lead your users to success, enlighten them, make them laugh more importantly show them your world
          </p>

          <form className='flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300 bg-white dark:bg-gray-800 rounded overflow-hidden'>
            <input
